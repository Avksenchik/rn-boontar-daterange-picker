...
export default class DateRangePicker extends Component {
  ...
  applyButton = () => {
    const { onApply, displayedDate } = this.props;
    onApply()
    this.onClose()
  };
        ...
        <View style={mergedStyles.backdrop}>
          ...
          <View>
            <View style={mergedStyles.container}>
              ...
              <TouchableOpacity  onPress={()=>this.applyButton()} style={{width: 120, height: 40, backgroundColor: '#3b83f7', marginLeft: 'auto', marginRight: 'auto', alignItems: 'center', justifyContent: 'center', borderRadius: 4, marginBottom: 10}}>
                  <Text style={{fontWeight: 'bold', fontSize: 14, color: 'white'}}>Применить</Text>
              </TouchableOpacity>
            </View>
          </View>
        </View>
